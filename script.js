...
// });
	...
	// vytvorime overlay
	var gallery = $('.gallery'), // najdeme galerii
  overlay = $('<div/>', { id: 'overlay' }); // prazdny div id="overlay"

// prilepime ho na spodek stranky, skryjeme
overlay.appendTo('body').hide();

// na galerii pripneme plosticu, event listener
...
gallery.on('click', 'a', function(event)
{
  ...
  var alt  = $(this).attr('alt'); // ziskame alt obrazku
    image = $('<img>', { src: href, alt: alt}); // vytvorime img z velkej adresy
